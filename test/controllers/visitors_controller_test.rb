...
class VisitorsControllerTest < ActionController::TestCase
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post :create, visitor: { email: @visitor.email, name: @visitor.name, poc: @visitor.poc, purpose: @visitor.purpose, time: @visitor.time }
    end
  ...
  test "should update visitor" do
    patch :update, id: @visitor, visitor: { email: @visitor.email, name: @visitor.name, poc: @visitor.poc, purpose: @visitor.purpose, time: @visitor.time }
    assert_redirected_to visitor_path(assigns(:visitor))
  end
