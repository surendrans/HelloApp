...
class CompanyUsersControllerTest < ActionController::TestCase
  ...
  test "should create company_user" do
    assert_difference('CompanyUser.count') do
      post :create, company_user: { email: @company_user.email, name: @company_user.name, phone_number: @company_user.phone_number }
    end
  ...
  test "should update company_user" do
    patch :update, id: @company_user, company_user: { email: @company_user.email, name: @company_user.name, phone_number: @company_user.phone_number }
    assert_redirected_to company_user_path(assigns(:company_user))
  end
